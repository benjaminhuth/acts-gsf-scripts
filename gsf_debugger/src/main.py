...
from processors import AverageTrackPlotter, ComponentsPlotter, MomentumGraph, BoundParametersProcessor
...
def main():
    ...
    if args["view"] == "cylindrical":
        ...
        drawers = [CsvXZDrawer(args["detector"], assume_telescope=True), CsvXYDrawer(args["detector"], assume_telescope=True)]
